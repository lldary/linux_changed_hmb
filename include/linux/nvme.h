...
#define show_nvm_opcode_name(val)                                              \
	__print_symbolic(val, nvme_opcode_name(nvme_cmd_flush),                \
...
#define show_admin_opcode_name(val)                                            \
	__print_symbolic(val, nvme_admin_opcode_name(nvme_admin_delete_sq),    \
...
#define show_fabrics_type_name(type)                                           \
	__print_symbolic(                                                      \
		type, nvme_fabrics_type_name(nvme_fabrics_type_property_set),  \
...
#define show_opcode_name(qid, opcode, fctype)                                  \
	((opcode) == nvme_fabrics_command ?                                    \
		 ...
		 ((qid) ? show_nvm_opcode_name(opcode) :                       \
